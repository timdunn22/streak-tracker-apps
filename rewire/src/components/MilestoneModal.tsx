        ...
        <div className="relative">
          ...
          <div className="flex gap-3 justify-center">
            <button
              ...
              className="bg-accent hover:bg-accent-glow text-white font-semibold py-3 px-8 rounded-2xl transition-all duration-200 ease-out active:scale-[0.97] min-h-[44px]"
            >
              Continue
            </button>
            <button
              ...
              className="bg-bg-card border border-border hover:border-accent/30 text-text-dim font-semibold py-3 px-6 rounded-2xl transition-all duration-200 ease-out active:scale-[0.97] min-h-[44px]"
