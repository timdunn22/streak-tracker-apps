      ...
      <div className="glass-accent rounded-2xl p-5 text-center">
        {state === 'success' ? (
          ...
          <>
            ...
            <button
              onClick={checkIn}
              className="w-full bg-accent hover:bg-accent-glow text-white font-semibold text-sm py-3 rounded-xl transition-all duration-200 ease-out active:scale-[0.97] flex items-center justify-center gap-2 min-h-[44px]"
