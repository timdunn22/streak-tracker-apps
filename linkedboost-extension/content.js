...
(() => {
  ...
  function createToolbar(composer) {
    ...
    // Accessibility note for Unicode formatting
    const a11yNote = document.createElement('span');
    a11yNote.className = 'lb-a11y-note';
    a11yNote.textContent = '\u26A0';
    a11yNote.title = 'Bold/Italic uses Unicode characters that screen readers may not parse correctly. Use sparingly for accessibility.';
    a11yNote.style.cssText = 'cursor:help;font-size:11px;opacity:0.6;margin-left:2px;';
    toolbar.appendChild(a11yNote);
